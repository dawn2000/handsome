...
function choseVditor($content)
{
    ...
    $cssUrl = $options->pluginUrl . '/Handsome/css/index.min.css?v=7.3.1';
    $jsUrl = $options->pluginUrl . '/Handsome/js/index.min.js?v=7.3.1';
        ...
        $(document).ready(function () {
            ...
            options.strings = {
                colorWordDialog: {
                    ...
                    "ret": '<span style="color:COLOR_VALUE">WORD_VALUE</span>\n'
